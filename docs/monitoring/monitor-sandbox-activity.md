...
- `localModelWorkflow.choices`, which exposes a dashboard-friendly list of saved local models plus the currently active route when local inference is onboarded.
